package 바킹독.재귀.problem;

import java.io.*;

/**
 * [실버 5] 재귀함수가 뭔가요? : https://www.acmicpc.net/problem/17478
 */
public class BOJ17478 {
    ...
    private static void recursion(int cnt, int n, String under) {
        // base condition
        if (n == cnt) {
